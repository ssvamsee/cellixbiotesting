  ...
  return (
      ...
      //     </CardGroup> 
          ...
          <div className='LeaderContainer'>
            ...
            <div className='LeaderTitleContainer'><h1 className='LeaderTile'>Mahesh Kandula</h1><span>Director Drug Design and Development</span><p className='Leadertext'> Innovation & IPFounder</p></div>
            </div>
            <div>
            <div className='LeaderSubTitleContainer'>  <div className='DescContainerh3'><span></span>
                <span className="WWDh3">About Mahesh Kandula</span><span></span>
                </div><hr className='LeaderHR'></hr>
            <div className='LeaderMsgContainer'><p className='LeaderMsg'>Mahesh brings over 18 years of scientific and entrepreneurial experience in the life science industry. Mr. Kandula has been named an inventor on 72 United States Issued Patents, 29 United States Patent Pending Applications and more than 226 International Patent Applications. Mr. Kandula received his Master of Technology degree from IIT Kharagpur.</p></div>
            </div>
            </div>
          </div>
